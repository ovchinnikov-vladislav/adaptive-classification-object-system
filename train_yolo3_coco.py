...
from libs.yolo3.layers import yolo_v3, yolo_v3_tiny, yolo_anchors, yolo_anchor_masks, yolo_tiny_anchors, \
    yolo_tiny_anchor_masks
from libs.yolo3.losses import YoloLoss
from libs.yolo3.utils import freeze_all, transform_images, transform_targets, load_tfrecord_dataset
...
if __name__ == '__main__':
    ...
    # train_dataset = tfds.load('coco', split='train', data_dir=args.dataset_path)
    # val_dataset = tfds.load('coco', split='validation', data_dir=args.dataset_path)
    # test_dataset = tfds.load('coco', split='test', data_dir=args.dataset_path)

    train_dataset = load_tfrecord_dataset('D:\\tensorflow_datasets\\coco\\2014\\1.1.0', args.classes, 416)
