...
def CapsNet(input_shape, n_class, routings):
    ...
    out_caps = Length(name='capsnet', num_classes=n_class)(digitcaps)

    y = layers.Input(ahep=(n_class,))
    ...
    masker_noised_y = Mask()([noised_digitcaps, y])
    manipulate_model = models.Model([x, y, noise], decoder(masker_noised_y))
...
def BaselineCapsNet(input_shape, n_class=2):
    x = layers.Input(shape=input_shape)
