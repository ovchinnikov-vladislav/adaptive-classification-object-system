...
class DiverseCapsuleNetwork(BaseModelForTraining):
    def create(self, input_shape, **kwargs):
        ...
        input1, primarycaps1, a1 = PrimaryCapsule2D(dim_capsules=12, num_capsules=10, kernel_size=5, strides=(2, 2))(
            m_8)
        ...
        input2, primarycaps2, a2 = PrimaryCapsule2D(dim_capsules=12, num_capsules=10,
                                                    kernel_size=5, strides=(2, 2))(m2_8)
        ...
        input3, primarycaps3, a3 = PrimaryCapsule2D(dim_capsules=12, num_capsules=10,
                                                    kernel_size=3, strides=(1, 1))(m3_8)
        ...
        out_caps = Length(name='length')(digitcaps)
