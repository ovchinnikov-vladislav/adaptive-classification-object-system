...
if __name__ == '__main__':
    ...
    class_names = ['jump', 'fall_floor', 'run', 'walk', 'sit', 'stand']
    ...
    model.load_weights(config.hmdb_caps_model)

    video = vread('D:/tensorflow_datasets/hmdb51/jump/DONNIE_DARKO_jump_f_nm_np1_fr_med_7.avi')
