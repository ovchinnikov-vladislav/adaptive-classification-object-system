...
if __name__ == '__main__':
    ...
    utils.plot_log(os.path.join(args.save_dir, f'history_training_{args.dataset}.csv'), 'acc', 'val_acc',
    ...
    utils.plot_log(os.path.join(args.save_dir, f'history_training_{args.dataset}.csv'), 'loss', 'val_loss',
