...
def youtube_video(video_id, user_id, detection_process_id):
    return get_video_with_tracking_objects(video_id, user_id, detection_process_id, type='youtube')
...
def camera_video(user_id, detection_process_id):
    ...
    return get_video_with_tracking_objects(video_addr, user_id, detection_process_id, type='video')
